    ...
    class Meta:
        ...
        widgets = {
            ...
            'descripcion': forms.Textarea(attrs={
                    'rows': 4,'class': 'w-full rounded-lg border-gray-300'
            }),

            'fecha_inicio': forms.DateTimeInput(attrs={
                    'type': 'datetime-local','class': 'w-full rounded-lg border-gray-300'
            }),
            ...
            'cantidad_estimada_personas': forms.NumberInput(attrs={
                    'class': 'w-full rounded-lg border-gray-300'
            }),
...
class PublicacionForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Formato para datetime-local cuando se edita
